...
const PLANS: Plan[] = [
  ...
  { name: "Web Design — Backend", price: "₦20,000", per: "/ month", desc: "PHP & MySQL — 2 classes/week (teaching + practical).", feats: ["2 classes/week (teaching + practical)", "MySQL & databases", "Dynamic web apps"], msg: "Hi, I'd like to enrol in Backend Web Design (PHP)." },
  { name: "UI/UX & Video Editing", price: "₦18,000", per: "/ month", desc: "Figma + professional video editing — 2 classes/week (teaching + practical).", feats: ["2 classes/week (teaching + practical)", "Premiere / CapCut", "Client-style projects"], msg: "Hi, I'd like to enrol in UI/UX & Video Editing." },
